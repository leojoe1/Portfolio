  ...
  const projects = [
    {
      ...
      model: import.meta.env.BASE_URL + "models/radio.glb",
      position: [2, 1.5, 0],
      scaleFactor: 0.06,
    },
    {
      ...
      model: import.meta.env.BASE_URL + "models/midnight.glb",
      position: [-2, 1, 0],
      scaleFactor: 0.15,
    },
    {
      ...
      model: import.meta.env.BASE_URL + "models/manuscrit.glb",
      position: [0, -2, 0],
      scaleFactor: 0.45,
    },
    {
      ...
      model: import.meta.env.BASE_URL + "models/sat.glb",
      position: [0, 2.5, -1],
      scaleFactor: 0.17,
    },
  ];
